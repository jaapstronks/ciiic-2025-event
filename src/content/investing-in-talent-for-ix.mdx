...
This interactive workshop focused on attracting, developing, and retaining talent within the Dutch immersive (IX) sector. Together with participants, the session mapped key opportunities and needs: What skills are essential? Where are the gaps? And how can talent be strengthened sustainably within the IX ecosystem? The session consisted of an interview, a user case, and breakout discussions, building on insights already gathered within CIIIC.
